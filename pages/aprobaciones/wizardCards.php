<div class="wizard" id="wizard_EditarSolicitud" data-title="">
    <div class="wizard-card" data-cardname="card1" style="height: 525px;">
      <h3 hidden>Datos generales del prestamo</h3>
       <input id="opcion" type="text" class="form-control" name="opcion" value=0  style = "visibility:hidden;">  
    ...
    <div class="wizard-card" data-cardname="card2" style="height: 525px;">
      ...
      <div class="row">
        ...
        <div class="form-inline">
          <div class="col-sm-4">
            <div class="form-group ">
              <input id="card2_Pnombre_sol" maxlength="30" type="text" class="form-control" name="card2_Pnombre_sol" value="" placeholder="Ingrese el primer nombre">                                        
            </div>
          </div>
          <div class="col-sm-4">
            <div class="form-group">
              <input id="card2_Snombre_sol" maxlength="30"  type="text" class="form-control" name="card2_Snombre_sol" value="" placeholder="Ingrese el segundo nombre">                                        
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="row">
        ...
        <div class="form-inline">
          <div class="col-sm-4">
            <div class="form-group">
              <input id="card2_Papellido_sol"maxlength="30" type="text" class="form-control" name="card2_Papellido_sol" value="" placeholder="Ingrese el primer apellido">                                        
            </div>
          </div>
          <div class="col-sm-4">
            <div class="form-group">
              <input id="card2_Sapellido_sol" maxlength="30" type="text" class="form-control" name="card2_Sapellido_sol" value="" placeholder="Ingrese el segundo apellido">                                        
            </div>
          </div>
        </div>        
      </div>
      ...
      <div class="row">
        ...
        <div class="col-xs-3 col-xs-offset-1">
          ...
          <div class="input-group">
            <div class="form-group">
              <input id="card2_RTN_sol" type="text" class="form-control numeros" maxlength="14" name="card2_RTN_sol" value="" placeholder="Ingresar RTN">                                        
            </div>
          </div>
        </div>
        <div class="col-xs-3 col-xs-offset-1 ">
        ...
        <div class="col-xs-5 col-xs-offset-1">
          <div class="form-group">
            ...
            <div class="input-group">
              ...
              <input id="card2_Tservicio" type="number"  min="0" class="form-control numeros" name="card2_Tservicio" value="" placeholder="Ingrese el tiempo del servicio">                                        
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="wizard-card" data-cardname="card5" style="height: 525px;">
        <h3 hidden>Resolución del Préstamo</h3>
        <br><br>
        <div class="row">
