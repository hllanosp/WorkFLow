        ...
        <div class="row">
            ...
            <div class="col-xs-5 col-xs-offset-0">
                <div class="form-group">
                    ...
                    <input  type = "number" min = "0" value=0 step = "0.1" name="card2_pagoVivienda" class = "numeros" id="card2_pagoVivienda" placeholder = "Pago Mensual">
        ...
        <div class="row">
            ...
            <div class="col-xs-5">
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <input id="card4_otroIngreso" type="number" min = "0" step="0.1" class="form-control" name="card4_otroIngreso" value="" placeholder="">                                        
                    </div>
                </div>
            </div>
        </div>
          ...
          <div class="col-xs-3 col-xs-offset-1">
            ...
            <div class="col-xs-4 col-xs-offset-1">
                <div class="form-group">
                    ...
                    <input  type = "number" min = "0" value=0 step = "0.1" name="card5_pagoVivienda" class = "numeros" id="card5_pagoVivienda" placeholder = "Pago Mensual">
                </div>
            </div>
        </div>
        <br>
        <div class="row">
            ...
            <div class="col-xs-5">
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <span class="input-group-addon">LPS</span>
                        <input id="card5_ingresoMensual" maxlength="11" type="number" step = "0.1" class="form-control" name="card5_ingresoMensual" placeholder="">                                        
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-xs-4 col-xs-offset-2">
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <span class="input-group-addon">LPS</span>
                        <input id="card6_sueldoMensual" maxlength="14" type="number" step = "0.1" min = "0" class="form-control" name="card6_sueldoMensual" >                                        
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-xs-3">
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <span class="input-group-addon">LPS</span>
                        <input id="card6_otrosIngresos" maxlength="14"  type="number" step = "0.1" min = "0" class="form-control" name="card6_otrosIngresos" value="" placeholder="">                                        
                    </div>
                </div>
            </div>
            ...
            <div class="panel-body" style=" ">
              <div class="row">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-7">
                      <input id="card7_trabajo" maxlength="100" type="text" class="form-control" name="card7_trabajo" value="" placeholder="">                                        
                    </div>
                </div>
                <div class="form-group">
            ...
            <div class="panel-body" style=" ">
              <div class="row">
                ...
                <div class="form-group">
                    <label style = "" class="control-label col-sm-4" for="email">Telefono Trabajo:</label>
                    <div class="col-sm-7">
                      <input id="card7_trabajo2" maxlength="100" type="text" class="form-control" name="card7_trabajo2" value="" placeholder="">                                        
                    </div>
                </div>
                <div class="form-group">
                    <label style = "" class="control-label col-sm-4" for="email">Parentesco:</label>
            ...
            <div class="panel-body" style=" ">
              <div class="row">
                ...
                <div class="form-group">
                    <label style = "" class="control-label col-sm-4" for="email">Telefono Trabajo:</label>
                    <div class="col-sm-7">
                      <input id="card8_trabajo" maxlength="100" type="text" class="form-control" name="card8_trabajo" value="" placeholder="">                                        
                    </div>
                </div>
                <div class="form-group">
