            ...
            case 4: // EDITAR SOLICITUD
                if(true){ //validacion de roles
                    ...
                    try{
                        ...
                        $query->bindParam(8,$card2_RTN, PDO::PARAM_STR);
                        $query->bindParam(9,$card2_sexo, PDO::PARAM_STR);
                        $query->bindParam(10,$card2_tipoVivienda, PDO::PARAM_INT);
                        $query->bindParam(11,$card2_pagoVivienda, PDO::PARAM_STR);
                        ...
                        $query->bindParam(25,$card3_plazo, PDO::PARAM_INT);
                        $query->bindParam(26,$card3_destino, PDO::PARAM_INT);
                        ...
                        $query->bindParam(34,$card4_telefonoExt, PDO::PARAM_STR);
                        $query->bindParam(35,$card4_jefe, PDO::PARAM_STR);
                        $query->bindParam(36,$card4_selectActividad, PDO::PARAM_INT);
                        $query->bindParam(37,$card5_Pnombre, PDO::PARAM_STR);
                        $query->bindParam(38,$card5_Snombre, PDO::PARAM_STR);
                        $query->bindParam(39,$card5_Papellido, PDO::PARAM_STR);
                        $query->bindParam(40,$card5_Sapellido, PDO::PARAM_STR);
                        $query->bindParam(41,$card5_identidad, PDO::PARAM_STR);
                        $query->bindParam(42,$card5_fechaNacimiento, PDO::PARAM_STR);
                        $query->bindParam(43,$card5_profesion, PDO::PARAM_STR);
                        $query->bindParam(44,$card5_ingresoMensual, PDO::PARAM_STR);
                        $query->bindParam(45,$card5_lugarLabor, PDO::PARAM_STR);
                        $query->bindParam(46,$card5_cargo, PDO::PARAM_STR);
                        $query->bindParam(47,$card5_tel, PDO::PARAM_STR);
                        $query->bindParam(48,$card5_cel, PDO::PARAM_STR);
                        $query->bindParam(49,$card5_tipoVivienda, PDO::PARAM_INT);
                        $query->bindParam(50,$card5_pagoVivienda, PDO::PARAM_STR);

                        $query->bindParam(51,$card6_Pnombre, PDO::PARAM_STR);
                        $query->bindParam(52,$card6_Snombre, PDO::PARAM_STR);
                        $query->bindParam(53,$card6_Papellido, PDO::PARAM_STR);
                        $query->bindParam(54,$card6_Sapellido, PDO::PARAM_STR);
                        $query->bindParam(55,$card6_identidad, PDO::PARAM_STR);
                        $query->bindParam(56,$card6_residencia, PDO::PARAM_STR);
                        $query->bindParam(57,$card6_direccion, PDO::PARAM_STR);
                        $query->bindParam(58,$card6_tel, PDO::PARAM_STR);
                        $query->bindParam(59,$card6_cel, PDO::PARAM_STR);
                        $query->bindParam(60,$card6_email, PDO::PARAM_STR);
                        $query->bindParam(61,$card6_estadoCivil, PDO::PARAM_INT);
                        $query->bindParam(62,$card6_dependientes, PDO::PARAM_INT);
                        $query->bindParam(63,$card6_empresa, PDO::PARAM_STR);
                        $query->bindParam(64,$card6_posicion, PDO::PARAM_STR);
                        $query->bindParam(65,$card6_tiempoServicio, PDO::PARAM_INT);
                        $query->bindParam(66,$card6_sueldoMensual, PDO::PARAM_STR);
                        $query->bindParam(67,$card6_otrosIngresos, PDO::PARAM_STR);
                        $query->bindParam(68,$card6_empresaTel, PDO::PARAM_STR);
                        $query->bindParam(69,$card6_empresaExt, PDO::PARAM_STR);
                        $query->bindParam(70,$card6_jefe, PDO::PARAM_STR);
                        $query->bindParam(71,$card6_selectActividad, PDO::PARAM_INT);
                        $query->bindParam(72,$card7_nombre, PDO::PARAM_STR);
                        $query->bindParam(73,$card7_tel, PDO::PARAM_STR);
                        $query->bindParam(74,$card7_trabajo, PDO::PARAM_STR);
                        $query->bindParam(75,$card7_parentesco, PDO::PARAM_STR);
                        $query->bindParam(76,$card7_nombre2, PDO::PARAM_STR);
                        $query->bindParam(77,$card7_tel2, PDO::PARAM_STR);
                        $query->bindParam(78,$card7_trabajo2, PDO::PARAM_STR);
                        $query->bindParam(79,$card7_parentesco2, PDO::PARAM_STR);
                        $query->bindParam(80,$card8_nombre, PDO::PARAM_STR);
                        $query->bindParam(81,$card8_tel, PDO::PARAM_STR);
                        $query->bindParam(82,$card8_trabajo, PDO::PARAM_STR);
                        $query->bindParam(83,$card8_parentesco, PDO::PARAM_STR);
                        $query->bindParam(84,$usuarioID, PDO::PARAM_INT);
                        $query->execute();
