...
switch($opcion){
        case 1: //  obtiene todas las solicitudes.
            if(true){ //validacion de roles
                ...
                $bandera = 0;
                try{
                    $query = $db->prepare("CALL SP_TRAER_SOLICITUDES_RRHH(@mensajeError,@codigoError)");
                    $query->execute();
        ...
        case 2: // envio de solicitud 
            if(true){ //validacion de roles
                ...
                try{
                    ...
                    $rrhh_salarioBruto = $_POST["rrhh_salarioBruto"];
                    $rrhh_salarioConDeduccion = $_POST["rrhh_salarioConDeduccion"];
                    $rrhh_derechos = $_POST["rrhh_derechos"];
                    $rrhh_antiguedad = $_POST["rrhh_antiguedad"];
                    $rrhh_comentario = $_POST["rrhh_comentario"];
                    $nuevoEstado = 3;

                    $query = $db->prepare("CALL SP_ENVIAR_SOLICITUD_RRHH(?,?,?,?,?,?,?,?, @mensajeError,@codigoError)");
                    $query->bindParam(1,$solicitudID, PDO::PARAM_INT);
                    $query->bindParam(2,$rrhh_salarioBruto, PDO::PARAM_STR);
                    $query->bindParam(3,$rrhh_salarioConDeduccion, PDO::PARAM_STR);
                    $query->bindParam(4,$rrhh_derechos, PDO::PARAM_STR);
                    $query->bindParam(5,$rrhh_antiguedad, PDO::PARAM_STR);
                    $query->bindParam(6,$rrhh_comentario, PDO::PARAM_STR);
                    $query->bindParam(7,$nuevoEstado, PDO::PARAM_INT);
                    $query->bindParam(8,$usuarioID, PDO::PARAM_INT);
                    $query->execute();
            ...
            case 4: // EDITAR SOLICITUD
                if(true){ //validacion de roles
                    ...
                    try{
                        ...
                        $card7_card7_tel = $_POST["card7_tel"];
                        ...
                        $query->bindParam(12,$card2_fechaNacimiento, PDO::PARAM_STR);
                        $query->bindParam(13,$card2_lugarNaci, PDO::PARAM_STR);
                        $query->bindParam(14,$card2_direccion, PDO::PARAM_STR);
                        $query->bindParam(15,$card2_nacionalidad, PDO::PARAM_STR);
                        $query->bindParam(16,$card2_residencia, PDO::PARAM_STR);
                        $query->bindParam(17,$card2_ocupacion, PDO::PARAM_STR);
                        $query->bindParam(18,$card2_email, PDO::PARAM_STR);
                        $query->bindParam(19,$card2_tel, PDO::PARAM_STR);
                        $query->bindParam(20,$card2_cel, PDO::PARAM_STR);
                        $query->bindParam(21,$card2_estadoCivil, PDO::PARAM_INT);
                        $query->bindParam(22,$card2_dependientes, PDO::PARAM_INT);
                        $query->bindParam(23,$card2_hijos, PDO::PARAM_INT);

                        $query->bindParam(24,$card3_cant, PDO::PARAM_STR);
                        $query->bindParam(25,$card3_plazo, PDO::PARAM_STR);
                        $query->bindParam(26,$card3_destino, PDO::PARAM_STR);
                        $query->bindParam(27,$card4_empresa, PDO::PARAM_STR);
                        $query->bindParam(28,$card4_sueldo, PDO::PARAM_STR);
                        $query->bindParam(29,$card4_tiempo, PDO::PARAM_INT);
                        $query->bindParam(30,$card4_cargo, PDO::PARAM_STR);
                        $query->bindParam(31,$card4_otroIngreso, PDO::PARAM_STR);
                        $query->bindParam(32,$card4_direccion, PDO::PARAM_STR);
                        $query->bindParam(33,$card4_telefono, PDO::PARAM_STR);
                        $query->bindParam(34,$card4_jefe, PDO::PARAM_STR);
                        $query->bindParam(35,$card4_selectActividad, PDO::PARAM_INT);

                        $query->bindParam(36,$card5_Pnombre, PDO::PARAM_STR);
                        $query->bindParam(37,$card5_Snombre, PDO::PARAM_STR);
                        $query->bindParam(38,$card5_Papellido, PDO::PARAM_STR);
                        $query->bindParam(39,$card5_Sapellido, PDO::PARAM_STR);
                        $query->bindParam(40,$card5_identidad, PDO::PARAM_STR);
                        $query->bindParam(41,$card5_fechaNacimiento, PDO::PARAM_STR);
                        $query->bindParam(42,$card5_profesion, PDO::PARAM_STR);
                        $query->bindParam(43,$card5_ingresoMensual, PDO::PARAM_STR);
                        $query->bindParam(44,$card5_lugarLabor, PDO::PARAM_STR);
                        $query->bindParam(45,$card5_cargo, PDO::PARAM_STR);
                        $query->bindParam(46,$card5_tel, PDO::PARAM_STR);
                        $query->bindParam(47,$card5_cel, PDO::PARAM_STR);
                        $query->bindParam(48,$card5_tipoVivienda, PDO::PARAM_INT);

                        $query->bindParam(49,$card6_Pnombre, PDO::PARAM_STR);
                        $query->bindParam(50,$card6_Snombre, PDO::PARAM_STR);
                        $query->bindParam(51,$card6_Papellido, PDO::PARAM_STR);
                        $query->bindParam(52,$card6_Sapellido, PDO::PARAM_STR);
                        $query->bindParam(53,$card6_identidad, PDO::PARAM_STR);
                        $query->bindParam(54,$card6_residencia, PDO::PARAM_STR);
                        $query->bindParam(55,$card6_direccion, PDO::PARAM_STR);
                        $query->bindParam(56,$card6_tel, PDO::PARAM_STR);
                        $query->bindParam(57,$card6_cel, PDO::PARAM_STR);
                        $query->bindParam(58,$card6_email, PDO::PARAM_STR);
                        $query->bindParam(59,$card6_estadoCivil, PDO::PARAM_INT);
                        $query->bindParam(60,$card6_dependientes, PDO::PARAM_INT);
                        $query->bindParam(61,$card6_empresa, PDO::PARAM_STR);
                        $query->bindParam(62,$card6_posicion, PDO::PARAM_STR);
                        $query->bindParam(63,$card6_tiempoServicio, PDO::PARAM_INT);
                        $query->bindParam(64,$card6_sueldoMensual, PDO::PARAM_STR);
                        $query->bindParam(65,$card6_otrosIngresos, PDO::PARAM_STR);
                        $query->bindParam(66,$card6_empresaTel, PDO::PARAM_STR);
                        $query->bindParam(67,$card6_jefe, PDO::PARAM_STR);
                        $query->bindParam(68,$card6_selectActividad, PDO::PARAM_INT);

                        $query->bindParam(69,$card7_nombre, PDO::PARAM_STR);
                        $query->bindParam(70,$card7_tel, PDO::PARAM_STR);
                        $query->bindParam(71,$card7_trabajo, PDO::PARAM_STR);
                        $query->bindParam(72,$card7_parentesco, PDO::PARAM_STR);
                        $query->bindParam(73,$card7_nombre2, PDO::PARAM_STR);
                        $query->bindParam(74,$card7_tel2, PDO::PARAM_STR);
                        $query->bindParam(75,$card7_trabajo2, PDO::PARAM_STR);
                        $query->bindParam(76,$card7_parentesco2, PDO::PARAM_STR);
                        $query->bindParam(77,$usuarioID, PDO::PARAM_INT);
                        $query->bindParam(78,$solicitud_id, PDO::PARAM_INT);
                ...
                case 5: // obtiene los comentarios para RRHH
                    if(true){ //validacion de roles
                    $json = array();
                    $msj ="";
                    $bandera = 0;
                    try{
                    $solicitudID = $_POST["solicitudID"];
                    $query = $db->prepare("CALL SP_OBTENER_COMENTARIOS_RRHH(?,@codigoError, @mensajeError);");
                    $query->bindParam(1, $solicitudID, PDO::PARAM_INT);
                    $query->execute();
                    $result = $query->fetchAll();
